...
var _api3= {
    _infoHintShare: "/query/api:51",
    _like: "/post/api:36",
    _guess: "/post/api:55",
    _likeList: "/post/api:52",
    _reviewList: "/query/api:54",
    _review: "/post/api:11",
    _joinList: "/query/api:53",
    ...
    _delhd:"/post/api:86",
    _mess:"/post/api:90",
    _recommend:"/query/api:91",
    _getWeiXinQr:"/post/api:93",
    _download:"/post/api:94",
    _stock:"/post/api:96",
    _isPayOrder:"/query/api:97",
    ...
    _footerInfo : "/query/api:123",
    _shopInfo : "/query/api:124",
    ...
    _userFavorite :"/post/api:160",
    _ifCollect :"/post/api:165",
    _confirmJoinParty :"/post/api:166",
    _posterLoad : "/post/api:171",
    _joinCancelPay : "/post/api:100",
    _manage_pay_apply : "/post/api:180"
};
/**跳转链接*/
var _g= function(url) {
    location.href = url;
...
var _cookie= {
    _set: function(name, value, expires) {
        ...
        if(_url.indexOf('.hdb.com')!=-1){
        	document.cookie=name+"="+escape(value)+(expires ? (";expires="+_end.toGMTString()) : "")+";path=/;domain=.hdb.com";
        }else if(_url.indexOf('.jootun.cn')!=-1){
        	document.cookie=name+"="+escape(value)+(expires ? (";expires="+_end.toGMTString()) : "")+";path=/;domain=.jootun.cn";
        }else{
        	document.cookie=name+"="+escape(value)+(expires ? (";expires="+_end.toGMTString()) : "")+";path=/;domain=192.168.1.224";
        }
    },
    _get: function(name) {
...
var _login4={
   ...
   _ok:function(json,code){
	  ...
	  if(way==1){
		  _$(_api3._ifCollect, "info_id=" + _info._id + "&info_type=" + _info._type, _login4._ifCollectToLike);
		  return false;
		  //_like._post();//赞
	  }else if(way==2){
		  _review._post();//评论
   ...
   _ifCollectToLike:function(json,code){
     _loading._hide();
	 if(code!=200){return;}
	 if(json.favorite=="0"){
		 _like._post();
	 }else if(json.favorite=="1"){
		 _toast._show("您已经收藏过");
	 }
	 _t._set("login_Way",0);
	 _login4._hide('tc_login');
...
$(document).ready(function() {
  ...
  //bi统计
  var Biurl = _domain + "hdb-bi?url=" + encodeURIComponent(document.URL) + "&t=" + +new Date() + "&refer=" + encodeURIComponent(document.referrer) + "&infoId=" + info_id + "&infoType=" + info_type +"&userId="+_user._id()+"&hdbId=" + _cookie._get("_hdb_id");
  var a = new Image();
  a.src = Biurl;
    ...
    if(obj.categorylist){
        ...
        for(var i = 0; i < obj.categorylist.length; i++){
            ...
            if(category.category_id != -1){
            	if( i == obj.categorylist.length-1 ){
...
function doSearch(searchWord){
    ...
    var area_code = $('.user_address_t span').attr('name');
    if( area_code == '-1'){
    	area_code = 'quanguo';
    };
    location.href = "/info_search?word=" + _._encode(searchWord)+ "&area_code=" + area_code ;
...
var _wakeApp = {
  _init:function(id){
    ...
    setTimeout(function() {
      _loading._hide();
      _download('/download_guide?from_z='+id);
    },5000);
  }
}
